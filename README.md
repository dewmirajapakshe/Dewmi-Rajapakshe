...
<head>
  ...
  <title>GitHub Stats - Dewmi Rajapakshe</title>
  <style>
    body {
...
<body>
  <div class="stats-container">
    ...
    <p>
      <a href="https://dewmirajapakshe.netlify.app/" target="_blank" rel="noopener noreferrer"><img alt="Portfolio" src="https://img.shields.io/badge/Portfolio-Visit-blue?style=for-the-badge&logo=about-dot-me" /></a>
      <a href="https://linkedin.com/in/dewmi-rajapakshe-914006366" target="_blank" rel="noopener noreferrer"><img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-Dewmi-blue?style=for-the-badge&logo=linkedin" /></a>
      <a href="mailto:dewmiozhadhi@gmail.com" target="_blank" rel="noopener noreferrer"><img alt="Email" src="https://img.shields.io/badge/Email-Contact-red?style=for-the-badge&logo=gmail" /></a>
    </p>
    ...
    <div class="canvas-container">
      <canvas id="githubCanvas" width="900" height="150"></canvas>
    </div>
  ...
  <script>
    const canvas = document.getElementById('githubCanvas');
    const ctx = canvas.getContext('2d');
    const gridSize = 10;
    const cols = canvas.width / gridSize;
    const rows = canvas.height / gridSize;

    // Sample data inspired by the image (green for commits, purple for highlights)
    const commits = [
    ...
    function drawCommits() {
      commits.forEach(commit => {
        ...
        ctx.fillRect(commit.x * gridSize, commit.y * gridSize, gridSize - 1, gridSize - 1);
      });
    }
